...
set xrange [ 0 : 40 ] noreverse nowriteback
set x2range [ * : * ] noreverse nowriteback
set ylabel "Computed Value" 
...
GNUTERM = "wxt"
plot 'SensorAveragesData.csv' using 0:1 with linesp title  "1", 'SensorAveragesData.csv' using 0:2 with linesp title "10", 'SensorAveragesData.csv' using 0:3 with linesp title "20", 'SensorAveragesData.csv' using 0:4 with linesp title "50"
#    EOF
